...
const findStaff= async () => {
    ...
    staff.forEach((colaborador) => {
        document.getElementById("staffList").insertAdjacentHTML(
            ...
            <div>
                <div class="StaffListaItem_nome">${`Nome: ${colaborador.nome}`}</div>
            ...
            <img class="StaffListaItem_pic" src=${colaborador.pic} alt=${`${colaborador.nome}`}/>
            </div>`,
        );
    });
};
...
const findColaboradorById = async () => {
    ...
    <div class ="StaffCardItem">
        <div>
            <div class="StaffListaItem_nome">${colaborador.nome}</div>
...
const submitColaborador = async () => {
    ...
    const html = `
        <div class ="StaffListaItem">
            <div>
                <div class="StaffListaItem_nome">${novoColaborador.nome}</div>
            ...
            <img class="StaffListaItem_pic" src=${novoColaborador.pic} alt=${`Foto de ${novoColaborador.nome}`} />
    </div>
    `;
